...
namespace InstaAutoPost.UI.Data.Migrations
{
    ...
    [Migration("20220619151551_SeedData")]
            ...
            modelBuilder.Entity("InstaAutoPost.UI.Data.Entities.Concrete.AutoJob", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Cron = "0 0 * * 0",
                            CronDescription = "Haftada 1 Kez",
                            InsertedAt = new DateTime(2022, 6, 19, 18, 15, 50, 201, DateTimeKind.Local).AddTicks(2669),
                            IsDeleted = false,
                            IsWork = false,
                            ...
                            UpdatedAt = new DateTime(2022, 6, 19, 18, 15, 50, 205, DateTimeKind.Local).AddTicks(9872)
                        },
                        new
                        {
                            Id = 2,
                            Cron = "0 20 * * *",
                            CronDescription = "Günde 1 Kez",
                            InsertedAt = new DateTime(2022, 6, 19, 18, 15, 50, 207, DateTimeKind.Local).AddTicks(3885),
                            IsDeleted = false,
                            IsWork = false,
                            ...
                            UpdatedAt = new DateTime(2022, 6, 19, 18, 15, 50, 207, DateTimeKind.Local).AddTicks(3910)
                        },
                        new
                        {
                            Id = 3,
                            Cron = "0 20 * * *",
                            CronDescription = "Günde 1 Kez",
                            InsertedAt = new DateTime(2022, 6, 19, 18, 15, 50, 207, DateTimeKind.Local).AddTicks(4067),
                            IsDeleted = false,
                            IsWork = false,
                            ...
                            UpdatedAt = new DateTime(2022, 6, 19, 18, 15, 50, 207, DateTimeKind.Local).AddTicks(4069)
                        },
                        new
                        {
                            Id = 4,
                            Cron = "0 0 * * 0",
                            CronDescription = "Haftada 1 Kez",
                            InsertedAt = new DateTime(2022, 6, 19, 18, 15, 50, 207, DateTimeKind.Local).AddTicks(4091),
                            IsDeleted = false,
                            IsWork = false,
                            ...
                            UpdatedAt = new DateTime(2022, 6, 19, 18, 15, 50, 207, DateTimeKind.Local).AddTicks(4092)
                        },
                        new
                        {
                            Id = 5,
                            Cron = "0 0 * * 0",
                            CronDescription = "Haftada 1 Kez",
                            InsertedAt = new DateTime(2022, 6, 19, 18, 15, 50, 207, DateTimeKind.Local).AddTicks(4111),
                            IsDeleted = false,
                            IsWork = false,
                            JobDescription = "Belirli periyotlarla daha önce klasörlenen içerikleri uygulamadan silen iş süreci",
                            JobName = "RemoveContentCreatedFolder",
                            JobTimeType = "LongTime",
                            JobTitle = "Otomatik Klasörlenen İçerikleri Sil",
                            UpdatedAt = new DateTime(2022, 6, 19, 18, 15, 50, 207, DateTimeKind.Local).AddTicks(4112)
                        },
                        new
                        {
                            Id = 6,
                            Cron = "0 0 * * 0",
                            CronDescription = "Haftada 1 Kez",
                            InsertedAt = new DateTime(2022, 6, 19, 18, 15, 50, 207, DateTimeKind.Local).AddTicks(4136),
                            IsDeleted = false,
                            IsWork = false,
                            JobDescription = "Belirli periyotlarla daha önce gönderilen mailleri uygulamadan silen iş süreci",
                            JobName = "RemoveSentMails",
                            JobTimeType = "LongTime",
                            JobTitle = "Otomatik Gönderilen Mailleri Sil",
                            UpdatedAt = new DateTime(2022, 6, 19, 18, 15, 50, 207, DateTimeKind.Local).AddTicks(4137)
                        });
                });
